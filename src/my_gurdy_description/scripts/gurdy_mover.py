...
class gurdyJointMover(object):
    ...
    def __init__(self):
        ...
        self.pub_head_upperlegM1_yaw_joint_position = rospy.Publisher(
            '/gurdy/head_upperlegM1_yaw_joint_position_controller/command',
            Float64,
            queue_size=1)
        self.pub_head_upperlegM2_yaw_joint_position = rospy.Publisher(
            '/gurdy/head_upperlegM2_yaw_joint_position_controller/command',
            Float64,
            queue_size=1)
        self.pub_head_upperlegM3_yaw_joint_position = rospy.Publisher(
            '/gurdy/head_upperlegM3_yaw_joint_position_controller/command',
            Float64,
            queue_size=1)
    ...
    def _check_joint_states_ready(self):
        ...
        while self.joint_states is None and not rospy.is_shutdown():
            print("Loop _check_joint_states_ready")
            try:
    ...
    def move_gurdy_all_joints(self, upperlegM1_angle, upperlegM2_angle, upperlegM3_angle, lowerlegM1_value, lowerlegM2_value ,lowerlegM3_value, headarm_value, headforearm_value, upperlegM1_yaw_angle, upperlegM2_yaw_angle, upperlegM3_yaw_angle, headarm_yaw_value, basefoot_peg_M1_value, basefoot_peg_M2_value, basefoot_peg_M3_value):
        ...
        self.pub_head_upperlegM2_yaw_joint_position.publish(upperlegM2_yaw)
        self.pub_head_upperlegM3_yaw_joint_position.publish(upperlegM3_yaw)
    ...
    def gurdy_move_ony_m1_yaw(self, angle):
        ...
        self.pub_head_upperlegM1_yaw_joint_position.publish(upperlegM1_yaw)
    ...
    def gurdy_check_continuous_joint_value(self, joint_name, value, error=0.1):
        ...
        if not similar:
            ...
            pass
            #rospy.loginfo("The joint ="+str(joint_name)+", reached ="+str(value))
    ...
    def gurdy_movement_look(self, upperlegM1_angle, upperlegM2_angle, upperlegM3_angle, lowerlegM1_value, lowerlegM2_value ,lowerlegM3_value, headarm_value, headforearm_value, upperlegM1_yaw_angle, upperlegM2_yaw_angle, upperlegM3_yaw_angle, headarm_yaw_value, basefoot_peg_M1_value, basefoot_peg_M2_value, basefoot_peg_M3_value):
        ...
        check_array = []
        check_array.append(similar_upperlegM1)
        check_array.append(similar_upperlegM2)
        check_array.append(similar_upperlegM3)
        check_array.append(similar_lowerlegM1)
        check_array.append(similar_lowerlegM2)
        check_array.append(similar_lowerlegM3)
        check_array.append(similar_upperlegM1_yaw)
        check_array.append(similar_upperlegM2_yaw)
        check_array.append(similar_upperlegM3_yaw)
        check_array.append(similar_basefoot_peg_M1_value)
        check_array.append(similar_basefoot_peg_M2_value)
        check_array.append(similar_basefoot_peg_M3_value)

        all_are_true = all(element for element in check_array)

        rate = rospy.Rate(check_rate)
        while not all_are_true and not rospy.is_shutdown():
            ...
            similar_upperlegM1_yaw = self.gurdy_check_continuous_joint_value(joint_name="head_upperlegM1_yaw_joint",
                                                                         value=position_upperlegM1_yaw)
            similar_upperlegM2_yaw = self.gurdy_check_continuous_joint_value(joint_name="head_upperlegM2_yaw_joint",
                                                                         value=position_upperlegM2_yaw)
            similar_upperlegM3_yaw = self.gurdy_check_continuous_joint_value(joint_name="head_upperlegM3_yaw_joint",
            ...
            rospy.loginfo("Check Array="+str(check_array))
            rospy.loginfo("Check all_are_true="+str(all_are_true))
    ...
    def jump(self, min_val=0.0, max_val=0.05, time_jump=1.0, direction="forwards"):
        ...
        """
        rospy.logdebug("time_jump=="+str(time_jump))
    ...
    def init_move_cmd_vel_pose(self):
        ...
        print("Start gurdy_movement_look...init_move_cmd_vel_pose")
    ...
    def _cmd_vel_callback(self, msg):
        ...
        print("Received cmd_vel message="+str( self.twist_value))
    ...
    def movement_cmd_vel(self):
        ...
        """       
        print("START Init Move CMD vel...")
        self.init_move_cmd_vel_pose()
        time.sleep(5)
        print("Init Move CMD vel finished")
        while not rospy.is_shutdown():  
            # print("Loop movement_cmd_vel")          
            #self.gurdy_hop()
            jump_value_fixed, direction = self.decide_movement()
            # print("jump_value_fixed="+str(jump_value_fixed))
    ...
    def movement_random_loop(self):
        ...
        self.init_move_cmd_vel_pose()
        while not rospy.is_shutdown():
            print("Loop movement_random_loop")          
            #self.gurdy_hop()
